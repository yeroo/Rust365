...
This document is the published code-signing policy for **Rust365**.
...
```
Get-FileHash .\Rust365-windows-x86_64.exe -Algorithm SHA256
# compare against Rust365-windows-x86_64.exe.sha256
```

Provenance (GitHub CLI):

```
gh attestation verify Rust365-windows-x86_64.exe --repo yeroo/Rust365
```
...
Rust365 is a local command-line tool. It performs no network access and
